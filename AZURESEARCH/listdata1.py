...
from azure.search.documents.indexes.models import SearchIndex, SimpleField, SearchField,SearchableField, HnswAlgorithmConfiguration, VectorSearch, VectorSearchAlgorithmConfiguration, VectorSearchProfile
            ...
            if sharepoint_data:
                ...
                for item in sharepoint_data:
                    document = {
                        ...
                        "GroupMembers": get_group_members(group_id),
                        "ContentEmbeddings": []  # Initialize content embedding field
