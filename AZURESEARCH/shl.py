...
def index_document_to_azure_search(file_name, file_content, file_id, permissions,web_url):
    ...
    for item in items:
        ...
        if 'folder' in item:
            ...
            if file_content:
                ...
                index_document_to_azure_search(item_name, file_content, item_id, permissions, web_url)
...
def main():
    create_index()
    index_sharepoint_items(ACCESS_TOKEN)
