...
def main():
    try:
        ...
        pdf_blobs = list_pdf_blobs(blob_storage_connection_string, container_name)
        for blob_name in pdf_blobs:
            pdf_content = download_pdf_from_blob(blob_storage_connection_string, container_name, blob_name)
