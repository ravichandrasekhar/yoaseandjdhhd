...
class _AzureOpenAISettings(BaseSettings):
    ...
    system_message: str = "You are an assistant tasked with providing a response based on the top 3 search results for a given query. Use the following information to generate a response:"
